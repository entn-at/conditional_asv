...
class Loader(Dataset):
	...
	def __init__(self, hdf5_name, max_nb_frames, n_cycles=100):
		...
		print('\nTotal number of speakers and languages: {}, {}\n'.format(len(self.speakers_list, self.languages_list)))
	...
	def create_lists(self):
		...
		for spk in self.speakers_list:
			...
			langlist.append(spk.split('-_-')[-1])

		langlist = set(langlist)

		self.lang2label = {}

		for i, lang in langlist:
			self.lang2label[lang]=i

		self.languages_list = list(langlist)
